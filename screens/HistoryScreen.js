        ...
        <View style={styles.chartContainer}>
          ...
          <LineChart
            ...
            chartConfig={{
              ...
              backgroundGradientFrom: '#81A6DB',
              backgroundGradientTo: '#A3BDE2',
              decimalPlaces: 0,
              ...
              formatYLabel: (yLabel) => {
                // This debugging line will show us what the chart is doing
                console.log("Chart is trying to format Y Label:", yLabel); 
                const key = Math.round(parseFloat(yLabel));
                return valueToMood[key] || '';
              },
            }}
            fromZero
            segments={4}
